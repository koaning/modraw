...
```python
from modraw import TangleSlider
```
...
```python
from modraw import TangleChoice
```
...
```python
from modraw import TangleSelect
```
...
```python
from modraw import CopyToClipboard
